...
//    SendMailService mailService;
    ...
    public Integer save(RegisterRequestModel request) {
        ...
        if(null != request) {
            ...
            userEntity.setCreateBy("Ford");
            userEntity.setCreateDate(new Date());
            userEntity.setUpdateBy("Ford S");
            ...
            if(null != userEntity) {
                ...
                userDetailEntity.setCreateBy("Ford");
                userDetailEntity.setCreateDate(new Date());
                userDetailEntity.setUpdateBy("Ford S");
    ...
    public Integer update(RegisterRequestModel request, Integer userId) {
        ...
        if(null != request) {
            ...
            if(userEntity.isPresent()) {
                ...
                user.setUpdateBy("update By Som");
                ...
                if(null != userDetail) {
                    ...
                    userDetail.setUpdateBy("update By Som");
